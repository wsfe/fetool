...
var Server = function () {
  function Server(options) {
    ...
    this.readConf().then(function (conf) {
      _this.app = (0, _express2.default)();
      _this.app.set('fet', conf);
      _this.app.use((0, _serveFavicon2.default)(sysPath.join(__dirname, '../../public', 'favicon.png')));
      _this.proxy(_this.app, conf);
      (0, _middlewares2.default)(_this.app, options);
      _this.start(options);
    });
  }
  ...
  _createClass(Server, [{
    key: 'proxy',
    value: function proxy(app, conf) {
      for (var projectName in conf) {
    ...
    key: 'readConf',
    value: function readConf() {
      return new Promise(function (resolve, reject) {
        fs.readJson(sysPath.join(process.cwd(), 'fet.conf')).then(function (conf) {
          resolve(conf);
        }).catch(function (err) {
          if (err.code === 'ENOENT') {
