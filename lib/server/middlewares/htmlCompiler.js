...
exports.default = function (cwd) {
  return function (req, res, next) {
    ...
    _fs2.default.readFile(_path2.default.join(cwd, pathname), 'utf8', function (err, data) {
      if (err) {
        next(err);
      } else {
        var content = data.toString();
        content = content.replace(INCLUDE_REG, function ($0, $1, $2, $3) {
          return _fs2.default.readFileSync(_path2.default.join(cwd, _url2.default.resolve(pathname, $2)), 'utf8');
        });
