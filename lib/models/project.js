...
var _webpackParallelUglifyPlugin = require('webpack-parallel-uglify-plugin');

var _webpackParallelUglifyPlugin2 = _interopRequireDefault(_webpackParallelUglifyPlugin);
...
var Project = function () {
  ...
  _createClass(Project, [{
    ...
    value: function getServerCompiler() {
      ...
      config.plugins.push(_plugins.progressPlugin);
