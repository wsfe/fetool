  ...
  _createClass(Project, [{
    ...
    value: function pack(options) {
      ...
      if (this.mode === SINGLE_MODE) {
        ...
        try {
          _utils2.default.fs.deleteFolderRecursive(outputPath);
        } catch (e) {
          error(e);
        }
        ...
        try {
          _utils2.default.fs.deleteFolderRecursive(outputPath); // cssConfig和jsConfig的out.path是一样的，所以只需要删除一次就行。
        } catch (e) {
          error(e);
        }
