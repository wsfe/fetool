...
var SingleConfig = function (_Config) {
  ...
  function SingleConfig(cwd, userConfig) {
    _classCallCheck(this, SingleConfig);

    var _this = _possibleConstructorReturn(this, (SingleConfig.__proto__ || Object.getPrototypeOf(SingleConfig)).call(this, cwd, userConfig));
  ...
  _createClass(SingleConfig, [{
    ...
    value: function fixPlugins() {
      ...
      if (!isExitExtractTextPlugin) {
        this.baseConfig.plugins.push(new _extractTextWebpackPlugin2.default('style.css'));
      }
    }
  }]);
