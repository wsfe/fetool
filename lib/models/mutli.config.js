  ...
  _createClass(MutliConfig, [{
    ...
    value: function setWebpackConfig() {
      ...
      if (typeof webpackConfig === 'function') {
        var result = webpackConfig.call(this, this.jsConfig, this.cssConfig, { env: this.NODE_ENV, plugins: { ExtractTextPlugin: _extractTextWebpackPlugin2.default }, webpack: _webpack2.default }, this);
        if (result.jsConfig) {
