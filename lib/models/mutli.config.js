...
var MutliConfig = function (_Config) {
  ...
  function MutliConfig(cwd, userConfig) {
    _classCallCheck(this, MutliConfig);

    var _this = _possibleConstructorReturn(this, (MutliConfig.__proto__ || Object.getPrototypeOf(MutliConfig)).call(this, cwd, userConfig));
  ...
  _createClass(MutliConfig, [{
    ...
    value: function setWebpackConfig() {
      ...
      if (typeof webpackConfig === 'function') {
        var result = webpackConfig(this.jsConfig, this.cssConfig);
        if (result.jsConfig) {
