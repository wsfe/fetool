...
var _extTemplatePath = _interopRequireDefault(require("../plugins/extTemplatePath"));
...
function () {
  ...
  _createClass(Config, [{
    ...
    value: function init() {
      ...
      this.baseConfig.plugins.push(new _extTemplatePath["default"]({
      ...
      this.fixOutput(this.baseConfig); // this.config = _.cloneDeep(this.baseConfig);
    }
  }, {
    key: "getMode",
    value: function getMode(env) {
    ...
    value: function setEntryExtNames(entryExtNames) {
      if (entryExtNames) {
        if (entryExtNames.js) {
          this.entryExtNames.js = _lodash["default"].concat(this.entryExtNames.js, entryExtNames.js);
          this.entryExtNames.js = _lodash["default"].uniq(this.entryExtNames.js);
        }

        if (entryExtNames.css) {
          this.entryExtNames.css = _lodash["default"].concat(this.entryExtNames.css, entryExtNames.css);
          this.entryExtNames.css = _lodash["default"].uniq(this.entryExtNames.css);
        }
      }
    }
    /**
    ...
    value: function setExports(entries) {
      ...
      if (entries) {
        ...
        } else if (_lodash["default"].isPlainObject(entries)) {
    ...
    value: function getConfig() {
      var config = _lodash["default"].cloneDeep(this.baseConfig);
